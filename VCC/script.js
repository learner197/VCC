...
try {
  ...
  /*
  webkitSpeechRecognition is supported by only chrome browser
  var --> means variable
  */
...
recognition.continuous = true;// continuously watch for instructions given through mic
...
$('#pause-record-btn').on('click', function(event) {
  recognition.stop();
